...
# CFG_CRYPTO_SM4_ARM_AESE defines whether the CPU supports AES single round
# encryption (AESE). These operations are part of the Cryptographic Extensions,
# so assume they are implicitly contained in CFG_CRYPTO_WITH_CE=y.
CFG_CRYPTO_SM4_ARM64_AESE ?= $(CFG_CRYPTO_SM4)
CFG_CORE_CRYPTO_SM4_ACCEL ?= $(CFG_CRYPTO_SM4_ARM64_AESE)
