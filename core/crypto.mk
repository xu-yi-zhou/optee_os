...
CFG_CRYPTO_SM4_ARM_NEON ?= $(CFG_CRYPTO_SM4)
CFG_CORE_CRYPTO_SM4_ACCEL ?= $(CFG_CRYPTO_SM4_ARM_NEON)
...
# The platform configured with CFG_CRYPTO_WITH_SM4_CE supports
# the ARMv8.2-A SM4 cryptographic extensions.
ifeq ($(CFG_CRYPTO_WITH_SM4_CE),y)
